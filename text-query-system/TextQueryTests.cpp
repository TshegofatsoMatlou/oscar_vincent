...
//	
//	// Create search word:
//	Word search_word("major");
//	vector<int> line_numbers;
//	
//	CHECK_FALSE(paragraph.contains(search_word, line_numbers));
//	
//	vector<int> expected_line_numbers;	
//	
//	expected_line_numbers.push_back(1);
//	
//	CHECK_FALSE(expected_line_numbers == line_numbers);
//}
////
//TEST_CASE("Word not present in Paragraph cannot be found") {
//	Paragraph paragraph;
//	
//	Line line1("This is a sentence a test sentence for paragraph.");
//	Line line2("the Dry concept states that we should not repeat ourselves");
//	Line line3("You can stand on the shoulders of giants or a BIG enough pile of dwarfs, works either way.");
//	Line line4("House Martell in Game of Thrones is key with beauty!.");
//	
//	// Add lines into paragraph:
//	paragraph.addLine(line1);
//	paragraph.addLine(line2);
...
//	
//	Line line1("This is a sentence a test sentence for paragraph.");
//	Line line2("the Dry concept  that states that we should not repeat ourselves");
//	Line line3("You are a BIG enough pile of dwarfs that, works either way.");
//	Line line4("House Martell in Game of Thrones is key with beauty!.");
//	// Add lines into paragraph:
//	paragraph.addLine(line1);
//	paragraph.addLine(line2);
